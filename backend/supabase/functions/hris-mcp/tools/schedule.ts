// Deno port of mcp-server/src/tools/schedule.ts.
...
export const assignEmployeesToScheduleTool: ToolDef<{
  ...
  description:
    ...
    'no-double-booking behavior. Employees on this schedule but missing from employee_ids are unassigned. Not ' +
    'guarded — reassignment is a routine, reversible HR operation.',
